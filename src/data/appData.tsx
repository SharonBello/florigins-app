...
export const flowerDefinitions: FlowerDefinition[] = [
  ...
  { country: 'Maldives', countryHebrew: 'מלדיביים', continent: 'Asia', continentHebrew: 'אסיה', scientificName: 'Pink Rose (Rosa polyantha)', scientificNameHebrew: 'Pink Rose (Rosa polyantha)', gradientStops: ['#FFC0CB', '#D8A3AC', '#B2868E', '#8C696F'], languageHebrew: 'דיבהי', cultureHebrew: 'מלדיבית', cuisineHebrew: 'מלדיבי' },
  ...
  { country: 'Philippines', countryHebrew: 'פיליפינים', continent: 'Asia', continentHebrew: 'אסיה', scientificName: 'Sampaguita (Jasminum sambac)', scientificNameHebrew: 'Sampaguita (Jasminum sambac)', gradientStops: ['#FFECB0', '#FFF5D7', '#FFFFFF', '#D6D4D4'], languageHebrew: 'פיליפינית', cultureHebrew: 'פיליפינית', cuisineHebrew: 'פיליפיני' },
  ...
  { country: 'Belgium', countryHebrew: 'בלגיה', continent: 'Europe', continentHebrew: 'אירופה', scientificName: 'Red Poppy (Papaver rhoeas)', scientificNameHebrew: 'Red Poppy (Papaver rhoeas)', gradientStops: ['#E61936', '#C3152D', '#A11125', '#7E0D1D'], languageHebrew: 'פלמית', cultureHebrew: 'בלגית', cuisineHebrew: 'בלגי' },
  ...
  { country: 'Czech Republic', countryHebrew: 'צ\'כיה', continent: 'Europe', continentHebrew: 'אירופה', scientificName: 'Lime Tree Blossom (Tilia cordata)', scientificNameHebrew: 'Lime Tree Blossom (Tilia cordata)', gradientStops: ['#C21807', '#A41405', '#871004', '#6A0D03'], languageHebrew: 'צ\'כית', cultureHebrew: 'צ\'כית', cuisineHebrew: 'צ\'כי' },
  ...
  { country: 'United Kingdom', countryHebrew: 'בריטניה', continent: 'Europe', continentHebrew: 'אירופה', scientificName: 'Tudor Rose (Rosa × alba)', scientificNameHebrew: 'Tudor Rose (Rosa × alba)', gradientStops: ['#F7D876', '#DD783F', '#C21807', '#6A0D03'], languageHebrew: 'אנגלית', cultureHebrew: 'בריטית', cuisineHebrew: 'בריטי' },
